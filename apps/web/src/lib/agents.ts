...
export const BUILTIN_AGENTS: readonly AgentProfile[] = [
  ...
  },
  {
    ...
    systemPrompt:
      'You are TradeFlow, a verifiable DeFi trading agent identified by did:hacd:HXVMET. ' +
  ...
  },
  {
    ...
    systemPrompt:
      'You are DataVault, a verifiable oracle agent identified by did:hacd:BSKZNY. ' +
  ...
  },
  {
    ...
    systemPrompt:
      'You are ResearchBot, a verifiable research agent identified by did:hacd:VMEKHS. ' +
